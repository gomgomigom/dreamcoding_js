...
console.clear();
class Employee {
  constructor(name, division, workTime, payRate) {
    this.name = name;
...
class FullTime extends Employee {
  ...
  constructor(name, division, workTime) {
    super(name, division, workTime, FullTime.PAY_RATE);
    this.pay = pay;
  }

  calculatePay = () => {
    this.pay = this.workTime * 10000;
  };
}

class PartTime extends Employee {
  calculatePay = () => {
    return super.workTime * 8000;
  };
}
